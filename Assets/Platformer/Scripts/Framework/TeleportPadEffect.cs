...
public class TeleportPadEffect : NetworkBehaviour, IInteractionEffect
{
    ...
    [SerializeField]
    private GameObject teleportStartVFX;
    [SerializeField]
    private SoundDef teleportStartSfx;
    [SerializeField]
    private float teleportDelay = 0.5f;

    [Header("Teleport End Effects")]
    [SerializeField]
    private GameObject teleportEndVFX;
    [SerializeField]
    private SoundDef teleportEndSfx;

    [Header("VFX & Audio Settings")]
    [SerializeField]
    private float vfxDuration = 2.0f;
    [SerializeField]
    private float sfxVolume = 1.0f;

    [Header("Movement Control")]
    [SerializeField]
    private bool disableMovementDuringTeleport = true;

    [Header("Pad Pairing")]
    [SerializeField]
    private int maxPadsPerPlayer = 2;
    [SerializeField]
    private float teleportHeightOffset = 1.0f;

    [Header("Access Control")]
    [SerializeField]
    private bool allowAllPlayers;
