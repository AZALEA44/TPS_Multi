...
public class JetpackAddon : NetworkBehaviour, IPlayerAddon
{
    ...
    [SerializeField]
    private JetpackLocomotionAbility jetpackAbility;
    ...
    [SerializeField]
    private GameEvent onJetpackPressed;
    [Tooltip("Event raised when the jetpack button is released.")]
    [SerializeField]
    private GameEvent onJetpackReleased;
    ...
    [SerializeField]
    private GameObject ribbonEffectPrefab;
    [Tooltip("Effect spawned when jetpack stops.")]
    [SerializeField]
    private GameObject stopEffectPrefab;
