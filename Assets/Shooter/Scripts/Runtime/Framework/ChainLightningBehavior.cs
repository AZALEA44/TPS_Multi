...
public class ChainLightningBehavior : NetworkBehaviour, IShootingBehavior
{
    ...
    [SerializeField]
    private float initialRange = 30f;
    [SerializeField]
    private float chainRange = 15f;
    [SerializeField]
    private int maxChains = 4;
    [SerializeField]
    private float chainAngle = 90f;
    [SerializeField]
    private float targetAcquisitionRadius = 0.5f;

    [Header("Damage Settings")]
    [SerializeField]
    private float baseDamage = 6f;
    [SerializeField]
    private float damageDecayPerChain = 0.7f;
    [SerializeField]
    private float hitForce = 50f;

    [Header("Arc Visual Settings")]
    [SerializeField]
    private Color lightningColor = new Color(0.4f, 0.8f, 1f, 1f);
    [SerializeField]
    private float arcWidthStart = 0.02f;
    [SerializeField]
    private float arcWidthEnd = 0.04f;
    [SerializeField]
    private float arcDuration = 0.15f;

    [Header("Arc Animation Settings")]
    [SerializeField]
    private int arcSegments = 12;
    [SerializeField]
    private float arcAmplitude = 0.3f;
    [SerializeField]
    private float arcFrequency = 8f;
    [SerializeField]
    private float arcAnimationSpeed = 10f;
    [SerializeField]
    private float arcJitter = 0.2f;

    [Header("Advanced Visual Settings")]
    [SerializeField]
    private Material arcMaterial;
    [SerializeField]
    private bool emitPointLights = true;
    [SerializeField]
    private float pointLightIntensity = 2f;
    [SerializeField]
    private float pointLightRange = 5f;
